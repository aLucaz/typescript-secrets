 ...
 * 
 * Typescript infers the generic type with the constructor
 * 
 */
...
/**
 * FACT 008 
 * You can have a generic class that EXTENDS from an interface
 * and ensure that the classes will have an attribute (id in this case)
 * 
 * 🫶 Third stage wins:
 *
